...
import { Menu, Instagram, MessageCircle, Calendar, MapPin, Clock, Car, CheckCircle2, Phone, Mail, X } from 'lucide-react';
...
export const Wireframe = () => (
  <div className="pb-24 relative font-sans bg-[#F9F6F0] text-[#4A4238] overflow-hidden">
    ...
    <section className="relative min-h-[85vh] flex items-center pt-20 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-black mb-6 leading-tight text-white font-sans tracking-normal">
            将来の不安に、<br/>今動く。
          </h1>
          <p className="text-gray-200 mb-10 text-base sm:text-lg md:text-xl max-w-xl leading-relaxed">
    ...
    <section id="concept" className="py-24 px-8 max-w-6xl mx-auto">
      ...
      >
        <h2 className="text-sm font-bold text-[#6B705C] tracking-widest mb-2">STRENGTHS</h2>
        <p className="text-3xl md:text-4xl font-black font-sans tracking-normal">GOATの3つの強み</p>
      </motion.div>
        ...
        {STRENGTHS.map((s, i) => (
          ...
          >
            <div className="flex-1 w-full overflow-hidden rounded-[2rem] shadow-lg shadow-[#4A4238]/10">
              <Image src={s.img} alt={s.title} className="w-full h-[300px] md:h-[400px] object-cover transition-transform duration-700 group-hover:scale-105" />
            </div>
    ...
    <section id="trainer" className="bg-[#F0EBE1] py-24 px-8">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-center">
        ...
        <motion.div 
          ...
          className="flex-1"
        >
          <h2 className="text-sm font-bold text-[#6B705C] tracking-widest mb-2">TRAINER</h2>
          <p className="text-3xl md:text-4xl font-black mb-8 font-sans tracking-normal">トレーナー紹介</p>
    ...
    <section id="pricing" className="py-24 px-8 max-w-5xl mx-auto">
      <motion.div 
        ...
        className="text-center mb-16"
      >
        <h2 className="text-sm font-bold text-[#6B705C] tracking-widest mb-2">MENU & PRICE</h2>
        <p className="text-3xl md:text-4xl font-black font-sans tracking-normal">料金プラン</p>
      </motion.div>
    ...
    <section id="faq" className="bg-[#F0EBE1] py-24 px-8">
      <div className="max-w-3xl mx-auto">
        <motion.div 
          ...
          className="text-center mb-16"
        >
          <h2 className="text-sm font-bold text-[#6B705C] tracking-widest mb-2">FAQ</h2>
          <p className="text-3xl md:text-4xl font-black font-sans tracking-normal">よくある質問</p>
        </motion.div>
    ...
    <section id="access" className="py-24 px-8 max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-center">
      ...
      >
        <div className="mb-8">
          <h2 className="text-sm font-bold text-[#6B705C] tracking-widest mb-2">ACCESS</h2>
          <p className="text-3xl md:text-4xl font-black font-sans tracking-normal">アクセス</p>
        </div>
